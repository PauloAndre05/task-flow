      ...
      <div className="flex p-8 gap-8">
        ...
        <div className="w-[30%] rounded-md p-6 bg-white h-fit">
          ...
          <div className="my-6">
            ...
            <span className="text-[#54577A]">UI UX Design . Apps Design</span>
          </div>
          ...
          <form className="mt-2">
            <input type="file" name="" id="" className="w-full border-dashed border-2 border-[#546FFF] p-4 place-content-center rounded-md h-[15rem] outline-0"/>
          </form>
          <p className="text-sm my-2 text-[#54577A]"t>*drag or browser from device</p>
          <button type="submit" className="w-full h-11 bg-[#546FFF] text-white rounded-xl cursor-pointer transition-colors hover: hover:bg-blue-50 hover:text-gray-700 mt-14">Submit</button>
        </div>
      </div>
    </div>
  );
